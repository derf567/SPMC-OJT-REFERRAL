        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button className="bg-red-600 text-white hover:bg-red-700" onClick={handleCancelInTransit} disabled={submitting || !cancellationReason.trim() || cancellationReason === "Others: "}>
