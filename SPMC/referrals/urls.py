...
from .views import ReferringHospitalViewSet, SpecialtyViewSet, ReferralViewSet, TransitInfoViewSet, ReferrerAccountViewSet, admin_dashboard_stats
from .authentication import (
    login_view, logout_view, user_profile, register_view, 
    comprehensive_register_view, register_doctor_view,
    pending_doctors_view, approve_doctor_view, reject_doctor_view
)
